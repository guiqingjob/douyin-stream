...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-black/40 backdrop-blur-md duration-300",
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "gap-5 rounded-xl bg-popover p-5 text-sm text-popover-foreground",
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-4 right-4 size-8 rounded-[var(--radius-control)]"
                size="icon"
              />
            }
          >
